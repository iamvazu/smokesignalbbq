            ...
            <section className="relative h-[90vh] flex items-center justify-center overflow-hidden mb-24">
                ...
                <div className="container mx-auto px-4 relative z-10 pt-24 md:pt-32 text-center">
                    ...
                    >
                        ...
                        >
                            {['✓ Established 2011', '✓ 15+ Areas', '✓ Same-Day', '✓ 5-Min Heat'].map((badge, idx) => (
                                <span key={idx} className="bg-fire/10 backdrop-blur-md border border-fire/20 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] text-fire shadow-xl">
                                    {badge}
                                </span>
                            ))}
                        </motion.div>
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display italic leading-[1.1] mb-6 tracking-tight">
                            <span className="text-cream opacity-90">From Our Pit</span> <br />
                            <span className="text-fire drop-shadow-2xl">To Your Plate</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            ...
                            <Button
                                variant="outline"
                                className="px-12 py-5 rounded-full text-lg hover:bg-white/10 transition-colors"
